...
public interface Rotatable {
	 ...
	 * @param angleDelta The angle by which to rotate this joint.
	 */
	void rotate(final Axis axis, final double angleDelta);

	/**
	 * Sets the minimum angle to which this joint can be rotated around the x axis.
	 * 
	 * @param newXNegativeExtent The minimum angle to which this joint can be
	 *                           rotated around the x axis.
	 */
	void setXNegativeExtent(final double newXNegativeExtent);

	/**
	 * Sets the maximum angle to which this joint can be rotated around the x axis.
	 * 
	 * @param newXPositiveExtent The maximum angle to which this joint can be
	 *                           rotated around the x axis.
	 */
	void setXPositiveExtent(final double newXPositiveExtent);

	/**
	 * Sets the minimum angle to which this joint can be rotated around the y axis.
	 * 
	 * @param newYNegativeExtent The minimum angle to which this joint can be
	 *                           rotated around the y axis.
	 */
	void setYNegativeExtent(final double newYNegativeExtent);

	/**
	 * Sets the maximum angle to which this joint can be rotated around the y axis.
	 * 
	 * @param newYPositiveExtent The maximum angle to which this joint can be
	 *                           rotated around the y axis.
	 */
	void setYPositiveExtent(final double newYPositiveExtent);

	/**
	 * Sets the minimum angle to which this joint can be rotated around the z axis.
	 * 
	 * @param newZNegativeExtent The minimum angle to which this joint can be
	 *                           rotated around the z axis.
	 */
	void setZNegativeExtent(final double newZNegativeExtent);

	/**
	 * Sets the maximum angle to which this joint can be rotated around the z axis.
	 * 
	 * @param newZPositiveExtent The maximum angle to which this joint can be
	 *                           rotated around the z axis.
	 */
